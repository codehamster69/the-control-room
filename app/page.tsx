  ...
  if (user && profile?.is_instagram_verified) {
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center p-6">
        ...
        {/* Navigation Cards - Updated to 2x2 grid (removed Gacha) */}
        <div className="grid grid-cols-2 gap-4 w-full max-w-2xl">
          {/* Hunt Bot */}
          <Link
            href="/hunt"
            className="group p-4 md:p-6 border-2 hover:bg-[#1a1a2e] transition-all hover:scale-105 text-center"
            style={{
              borderColor: "#ffc800",
          ...
          >
            <svg
              className="w-10 h-10 mx-auto mb-3 text-amber-500 group-hover:animate-bounce"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p className="text-gray-400 font-mono text-[10px]">Auto collect</p>
          </Link>
          ...
          >
            <Users className="w-10 h-10 mx-auto mb-3 text-cyan-500 group-hover:animate-bounce" />
            <h3
              className="font-bold mb-1"
              style={{
                fontFamily: "'Press Start 2P', cursive",
            ...
            <p className="text-gray-400 font-mono text-[10px]">Inventory</p>
          </Link>
          ...
          >
            <svg
              className="w-10 h-10 mx-auto mb-3 text-yellow-500 group-hover:animate-bounce"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p className="text-gray-400 font-mono text-[10px]">Top players</p>
          </Link>
          ...
          >
            <svg
              className="w-10 h-10 mx-auto mb-3 text-green-500 group-hover:animate-bounce"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
